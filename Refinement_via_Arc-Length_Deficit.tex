...
\Cref{alg:discreteoptimize}, often referred to as adaptive refinement or enrichment (see above), would be applied for each segment in the 
discretization. Also, since the 
