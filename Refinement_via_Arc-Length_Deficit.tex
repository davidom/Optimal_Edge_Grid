...
This would generate an optimal solution using two segments to represent 
...
segments. 
%Consider that the red triangle in 
%Figure-\ref{CurvatureRatioTriangles} has a larger perimeter than the blue 
%triangle; therefore the red triangle would be considered ``more 
%optimal.'' 
